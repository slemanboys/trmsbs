...
platform_browser = {
'Windows': r'"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" --kiosk https://tiramisu.fansub.id/',
'Linux' : ['/usr/bin/chromium-browser', '--kiosk', 'https://tiramisu.fansub.id/']
}
